...
class PublicRecipeApiTest(TestCase):
    ...
    def test_auth_required(self):
        ...
        response = self.client.get(RECIPE_URLS)
...
class PrivateRecipeApiTest(TestCase):
    ...
    def test_recipes_limited_to_used(self):
    ...
    def test_create_basic_recipe(self):
        ...
        response = self.client.post(RECIPE_URLS, payload)
    ...
    def test_partial_update_recipe(self):
        """Updating a recipe with patch"""
        recipe = sample_recipe(user=self.user)
        recipe.add(sample_tag(user=self.user))
...
class RecipeImageUploadTests(TestCase):
    """Test the image feature of the recipe API"""
    ...
    def test_filter_recipes_by_tags(self):
        ...
        recipe1 = sample_recipe(user=self.user, title='Thai vegeCurry')
